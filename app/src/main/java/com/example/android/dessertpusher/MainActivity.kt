...
const val  DESSERT_TIMER = "desserts_timer"
...
//        dessertTimer.secondsCount = savedInstanceState?.
...
//        fiveSold()
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt("desserts_timer", dessertTimer.secondsCount)

        Timber.i("onSaveInstanceState Hello! ")

    }

//    fun fiveSold(){
//        if (dessertsSold == 5){
//            error("ERROR, You'll be Fat STOP!")
//        } else dessertsSold++
//    }
